#!/usr/bin/env php
#Dilarang copyright coded Mrlinkerrorsystem 2019
<?php
...
echo $R."\n::############[WELCOME:MY:HOME]##################";
echo $YY."\n::#:                                                   #";
echo $BB."\n::#:Penutor  ::[Mrlinkerrorsystem]                     #";
echo $B."\n::#:Website  ::[https://Mrlinkerrorsystem.blogspot.com] #";
echo $RR."\n::#:Github   ::[http://github.com/CyberMrlink:]        #";
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		echo "[]Mrlink Sending Massage To[] # ".$G.$argv[1].$X."\n";	
...
while(1) {
foreach($argv[1] as $argv[2]):
echo "[]Mrlink Sending Massage To[] # ".$G.$argv[2].$X."\n";
